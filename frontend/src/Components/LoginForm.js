...
function LoginForm({ Login, Signup }) {
  ...
  return (
    <form
      ...
      onSubmit={(e) => submitHandler(e, issignup ? Signup : Login)}
    >
      <div className="inputwrapper">
        <label>Email Addressasd</label>
        <input
          type="text"
          id="email"
          name="email"
      ...
      <div className="inputwrapper">
        ...
        <input
          ...
          name="password"
          disabled
          placeholder="Password functionality not supported yet. Proceed the login/signup with the email address."
        ></input>
      </div>
      ...
      {issignup ? (
        ...
        >
          Already have an account? Click here to log into an existing account.
        </a>
      ) : (
        <a
          onClick={(e) => {
