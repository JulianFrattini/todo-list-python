...
class DAO:
    ...
    def __init__(self, collection_name: str):
        """Establish a data access object to a collection of the given name
        in the MongoDB database as specified in the environment variables. When the collection is first creted,
    ...
    def create(self, data: dict):
        ...
        which defines the data structure of the collection. In particular,
        the validator has to make sure that: 
