...
class DAO:
    ...
    def __init__(self, collection_name: str):
        """Establish a data access object to a collection of the given name in the MongoDB database as specified in the environment variables. When the collection is first creted, it will be associated to a validator 
        (see https://www.mongodb.com/docs/manual/core/schema-validation/) to ensure some basic data compliance.
    ...
    def create(self, data: dict):
        """Creates a new document in the collection associated to this data access object. The creation of a new document must comply to the corresponding validator, which defines the data structure of the collection.
